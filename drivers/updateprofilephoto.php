                            ...
                            <div class="col-lg-7">
                                <!-- <div class="card shadow-lg border-0 rounded-lg mt-5"> -->
                                    ...
                                    <div class="container">
                                        ...
                                        <form method = "post" action="updateprofilephoto.php" enctype="multipart/form-data">
                                            ...
                                            <?php                
                                             if(isset($_POST['update'])){
                                                ...
                                                if($image!="NULL"){
                                                    ...
                                                    $query1 = "update drivers set img = '$image' where d_id = $did";
                                                    if(mysqli_query($con,$query1)){
                                                        echo "<script>window.location.href='updateprofilephoto.php'</script>" ;
