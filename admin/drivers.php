    ...
    <body>
        ...
        <div id="layoutSidenav_content">
         ...
         <div class = "text-center d">
          ...
          <div class = "">
        <a class = "btn btn-primary" href ="createdriver.php">Create</a>
        </div>          
        <table class="table table-striped">
            ...
            <td></td>
                    ...
                    <td>
                        <a class = "btn btn-primary" href ="updatedrivers.php?id=<?php  echo $row['d_id']?>">Edit</a>
                        <!-- Trigger the modal with a button -->
                        <a class = "btn btn-danger" data-toggle="modal" data-target="#myModal<?php  echo $row['d_id'];?>">Delete</a>
                        <!-- Modal -->
                        <div class="modal" id="myModal<?php  echo $row['d_id'];?>">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                <a class = "btn btn-success" href ="deletedriver.php?id=<?php  echo $row['d_id']?>">yes</a>
